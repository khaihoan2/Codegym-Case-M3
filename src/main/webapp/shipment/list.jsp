                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="/shipment?action=create" class="btn btn-primary" style="width: 84px">Create</a>
                            </div>
                        </div>
                                ...
                                <c:forEach items="${shipments}" var="shipment">
                                    <tr>
                                        ...
                                        <td class="project-actions text-right d-flex justify-content-end">
                                            <a class="btn btn-info btn-sm mr-2" href="/shipment?action=edit&id=${shipment.id}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm " href="/shipment?action=delete&id=${shipment.id}">
