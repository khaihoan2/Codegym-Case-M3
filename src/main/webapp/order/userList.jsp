...
<div class="container" style="margin-top: 58px; margin-bottom: 58px">
    <div class="card" style="border: 1px solid #ccc; border-radius: 4px">
        <div class="card-header">
            <h3 class="card-title" style="padding: 16px 10px">Order</h3>
        </div>
        <div class="card-body p-0">
            <h4 style="margin-left: 10px; margin-top: 10px">Create at:</h4>
            <h4 style="margin-left: 10px; margin-top: 10px">Shipment: </h4>
            <h4 style="margin-left: 10px; margin-top: 10px">Payment: </h4>
