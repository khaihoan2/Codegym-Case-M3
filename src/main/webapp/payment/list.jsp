                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="/payment?action=create" class="btn btn-primary" style="width: 84px">Create</a>
                            </div>
                        </div>
                                ...
                                <c:forEach items="${payments}" var="payment">
                                    <tr>
                                        ...
                                        <td class="project-actions text-right d-flex justify-content-end">
                                            <a class="btn btn-info btn-sm mr-2" href="/payment?action=edit&id=${payment.id}">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-danger btn-sm " href="/payment?action=delete&id=${payment.id}">
